...
public class CityPassTester {
    public static void main(String[] args) {
        ...
        CityPass unlimitedCP = new UnlimitedCityPass(attractions, "Olivia",
        ...
        CityPass limitedVisitsCP = new LimitVisitsCityPass(attractions,
        ...
        CityPass endDateCP = new EndDateCityPass(attractions, "Walter",
