...
public class LoanTester {
    public static void main(String[] args) {
        ...
        Loan l1 = new Loan(Destinatario.PERSONAL, 1000, LocalDate.of(2022, 9, 1), 3);
        ...
        // y las fechas de los mismos deben ser posteriores a la fecha del préstamo
        Loan l2 = new LoanLastQuota(Destinatario.AUTOMOTOR, 2000, LocalDate.of(2022, 9, 1), 3);
        ...
        Loan l3 = new LoanLastDate(Destinatario.HIPOTECARIO, 3000, LocalDate.of(2022, 9, 1), 3);
        ...
        try {
            ...
            new Loan(Destinatario.PERSONAL, 75000, LocalDate.of(2022, 9, 1), 3);
        } catch (LoanException ex) {
        ...
        try {
            ...
            new Loan(Destinatario.AUTOMOTOR, 3000, LocalDate.of(2022, 9, 1), 30);
        } catch (LoanException ex) {
            System.out.println(ex.getMessage()); // Invalid Loan.
        }
    }
